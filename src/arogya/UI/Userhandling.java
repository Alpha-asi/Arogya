 ...
 * @author ADMIN
 */
public class Userhandling extends javax.swing.JFrame {
    Essencials es;
    DefaultTableModel tbcus;


    /**
     * Creates new form Userhandling
     */
    public Userhandling() {
        setUndecorated(true);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel11.setText("User Handling");
...
static int xx,yy;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Userhandling.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                  try {
                    ...
                    new Userhandling().setVisible(true);
                } catch (Exception e) {
            }
            }
        });
