 ...
 * @author ADMIN
 */
public class Addbreakfastsuccess extends javax.swing.JFrame {
   Essencials es = new Essencials();
    /**
     * Creates new form Addbreakfastsuccess
     */
    public Addbreakfastsuccess() {
        setUndecorated(true);
        initComponents();
    ...
    private void addfoodActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addfoodActionPerformed
       try {
           ...
           Logger.getLogger(Addbreakfastsuccess.class.getName()).log(Level.SEVERE, null, ex);
       }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Addbreakfastsuccess.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ...
                    new Addbreakfastsuccess().setVisible(true);
                } catch (Exception e) {
                }
            }
        });
